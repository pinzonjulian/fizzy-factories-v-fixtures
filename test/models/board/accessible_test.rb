...
class Board::AccessibleTest < ActiveSupport::TestCase
  test "revising access" do
    ...
    boards.writebook.accesses.revise granted: [users.david, users.jz], revoked: [users.kevin, users.jason]
  ...
  test "grants access to everyone after update" do
    ...
    assert_equal accounts._37s.users.active.sort, board.users.reload.sort
  end

...
class User::RoleTest < ActiveSupport::TestCase
  ...
  test "owner scope returns only active owners" do
    owners = accounts._37s.users.owner
    ...
    assert_not_includes accounts._37s.users.owner, users.jason
  end

  test "admin scope returns active owners and admins" do
    admins = accounts._37s.users.admin
    ...
    assert_not_includes accounts._37s.users.admin, users.kevin
  end

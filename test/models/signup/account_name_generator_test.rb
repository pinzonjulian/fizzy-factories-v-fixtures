...
class Signup::AccountNameGeneratorTest < ActiveSupport::TestCase
  ...
  test "generate" do
    ...
    first_account = Account.create!(name: account_name)
    ...
    second_account = Account.create!(name: account_name)
    Current.without_account do
    ...
    third_account = Account.create!(name: account_name)
    Current.without_account do
    ...
    fourth_account = Account.create!(name: account_name)
    Current.without_account do
  ...
  test "generate continues from the previous highest index" do
    account = Account.create!(name: "Newart's 12th Fizzy")
    Current.without_account do
